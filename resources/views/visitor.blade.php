...
<style>
    ...
    .section-bg.visible > .bg-gabung {
        opacity: 0.8 !important; /* Adjust this value (0.5 to 1.0) to control brightness */
    }
...
<body class="bg-black md:mx-11">
    <!-- Header -->
    <div class="sticky top-0 bg-black bg-opacity-80 backdrop-blur-md w-full z-50 transition-all duration-300" id="header">
    ...
    <div class="section-bg pt-[50vh] flex flex-col px-10 pb-20 fade-section" id="intro">
    ...
    <div class="section-bg flex flex-col justify-center items-center py-16 px-10 fade-section" id=gabung>
        ...
        <div
            ...
            <h1 class="text-5xl text-white text-center font-bold py-10" style="text-shadow: 0px 0px 25px rgba(255, 255, 255, 0.4)">
                Gym-In
            </h1>
