        ...
        <div class="w-full max-w-6xl mt-6">
            <div class="p-6 rounded-xl backdrop-blur-sm bg-white/10">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="reward-card p-4 rounded-xl backdrop-blur-sm bg-white/5">
                            <div class="flex items-start justify-between">
                                ...
                                <button class="btn-tukar bg-emerald-600/80 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-emerald-600 transition">
                                    TUKAR
                                </button>
                            </div>
                        </div>
                ...
                <div class="mt-6 text-center">
                    <a href="/rewards" class="text-emerald-400 hover:underline text-sm">
        ...
        <div class="w-full max-w-6xl mt-8">
            <div class="p-6 rounded-xl backdrop-blur-sm bg-white/10">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <!-- Progress Link Card -->
                    <div class="stat-card p-4 rounded-xl backdrop-blur-sm bg-white/5 flex flex-col items-center justify-center">
                        <a href="/progres" class="text-emerald-400 hover:underline text-sm">
