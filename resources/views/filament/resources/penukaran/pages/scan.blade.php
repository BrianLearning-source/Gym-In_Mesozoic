<x-filament-panels::page>
    <style>
        /* Memaksa elemen html5-qrcode tunduk pada batasan ukuran kita */
        #qr-reader {
            width: 100% !important;
    ...
    {{-- Layout Flex: Kolom di HP, Baris Menyamping di PC (md) --}}
    <div class="flex flex-col md:flex-row gap-6 items-start w-full">
        
        {{-- BAGIAN KIRI: Form Input Manual (Memakan 50% layar di PC) --}}
        ...
        {{-- BAGIAN KANAN: Scanner Kamera (Memakan 50% layar di PC) --}}
        <div class="w-full md:w-1/2">
            <x-filament::section>
                <x-slot name="heading">Scan QR Penukaran</x-slot>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            Livewire.on('scan-result', (data) => {
                // Notifikasi dikelola oleh controller Livewire
            });
        });
    </script>
    @endpush
