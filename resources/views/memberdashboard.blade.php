...
<body class="bg-black md:mx-11">
    ...
    <div class="flex flex-col items-center justify-center px-4 py-8 md:px-10">
        ...
        <div class="flex items-center justify-between w-full max-w-6xl mt-8">
            ...
            <!-- Avatar Circle -->
            <div
                class="w-14 h-14 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 shadow-lg flex items-center justify-center overflow-hidden border-2 border-white/20">
                {{-- <span class="text-2xl text-white">👤</span> --}}
                <img src="https://pbs.twimg.com/media/E8YT2mbVcAIA5vv?format=jpg&name=small" alt="Profile Picture" class="w-full h-full object-cover">
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="reward-card p-4 rounded-xl backdrop-blur-sm bg-white/5">
                            <div class="flex items-start justify-between">
                                ...
                                <button
                                    class="btn-tukar bg-emerald-600/80 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-emerald-600 transition">
                                    TUKAR
                                </button>
                            </div>
                        </div>
        ...
        <div class="w-full max-w-6xl mt-8">
            <div class="p-6 rounded-xl backdrop-blur-sm bg-white/10">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <!-- Progress Link Card -->
                    <div
                        class="stat-card p-4 rounded-xl backdrop-blur-sm bg-white/5 flex flex-col items-center justify-center">
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-black/90 backdrop-blur-sm border-t border-white/10 max-w-md mx-auto">
        <div class="flex justify-around items-center px-4 py-3">
            <a href="{{ route('member.dashboard') }}" class="flex flex-col items-center text-emerald-400 transition">
